...
/**
 * Field structure in data files:
 * 
 * Date, Adj. Open, Adj. high, Adj. low, Adj. close, ?, ?, ?, ?, unadj. close
 * 
 * @author ustaudinger
 * 
 */
public class ImportCSI {
    ...
    public ImportCSI(String directory, final String mdprovider, String springInitFile) throws Exception {
    ...
    class AnonymousWorker extends Worker<String> {
        ...
        public void importFile(String fileName, String providerspecificid, String mdprovider) throws Exception {
            ...
            while (l != null) {
                ...
                String timeStampS = splitted[0] + " 23:59:59.000";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String mdprovider = "CSI";
        new ImportCSI(startFolder, mdprovider, "initdblive.xml");
